...
class NewPostViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func sharePressed(_ sender: Any) {
        ...
        let userRef = Firestore.firestore().collection("Users").document(userID).collection("posts").document(postRefDocumentID)
            ...
            var dataDictionary: [String: Any] = ["title": titleTextField.text, "description": textView.text, "documentID": postRefDocumentID, "createTime": getDate(), "originalPoster": userID, "thanksCount":0, "wowCount":0, "haCount":0, "niceCount":0,]
